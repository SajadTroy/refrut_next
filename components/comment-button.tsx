...
export default function CommentButton({ commentCount }: CommentButtonProps) {
  ...
  return (
    <button className={`${styles.actionButton} ${commented ? styles.commented : ""}`} onClick={handleComment}>
      {commented ? (
